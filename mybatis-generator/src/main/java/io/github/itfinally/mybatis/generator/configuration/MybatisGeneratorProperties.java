...
import io.github.itfinally.mybatis.generator.exception.LackOfConfigurationException;
...
public class MybatisGeneratorProperties {
  ...
  public String getFileParentPath() {
    return Strings.isNullOrEmpty( fileParentPath ) ? System.getProperty( "user.dir" ) : fileParentPath;
  }
  ...
  private String mixPath( String path ) {
    String parentPath = getFileParentPath().trim();
