...
import io.github.itfinally.mybatis.jpa.entity.EntityMetadataToken;
import io.github.itfinally.mybatis.jpa.entity.ForeignAttributeMetadata;
import io.github.itfinally.mybatis.jpa.exception.DuplicatePrimaryKeyException;
import io.github.itfinally.mybatis.jpa.exception.MissingPrimaryKeyException;
import io.github.itfinally.mybatis.jpa.exception.NoSuchActualTypeException;
  ...
  private static void createAttributeAndInject( EntityMetadata metadata, Set<ForeignAttributeMetadata> foreignAttributeMetadataTokens ) {
    ...
    for ( PropertyDescriptor pd : beanInfo.getPropertyDescriptors() ) {
      ...
      if ( Collection.class.isAssignableFrom( attributeType ) ) {
        ...
        actualDeclareType = attributeType;
        targetEntityType = relationship.getTargetEntity();
      ...
      if ( targetEntityType != null ) {
        ...
        foreignAttributeMetadataTokens.add( foreignAttributeMetadata.setReferenceAttributeMetadata(
            new AttributeMetadata().setJdbcName( column.joinColumn.referencedColumnName() ) )
